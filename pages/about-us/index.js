        ...
        <div className={`w-full h-full flex flex-col gap-6 py-6 px-6 md:px-24 bg-borabayImpureWhite`} id='about-us'>
            ...
            <div className='w-full h-[90%] flex flex-row flex-wrap md:flex-nowrap gap-6 md:gap-24'>
                ...
                <div className='w-full md:w-1/2 flex flex-col gap-4'>
                    ...
                    <span className='text-borabayDarkBrown font-normal text-xl text-right'>We are a team of professionals, who understand the matrix behind beauty and bring out the best of it for you. At Borabay, a variety of services and customer experience is our priority. From a range of hair styling services, beauty treatments, and cosmetic advances to rejuvenation rituals - We are a one-stop destination for renewal & restoration.</span>
                </div>
            </div>
        </div>
    );
