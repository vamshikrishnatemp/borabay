...
function FindUs(props) {
    return (
        <div className={`w-screen h-max lg:h-screen py-6 px-6 lg:px-24 flex flex-col items-center gap-6 bg-borabayImpureWhite`} id='find-us'>
            ...
            <div className='w-full h-[60%] flex flex-row flex-wrap lg:flex-nowrap gap-4 lg:gap-20 justify-center items-center'>
                ...
                <div className='w-[90%] h-[70%] lg:w-[40%] lg:h-[90%] flex flex-col gap-2 justify-between items-center text-center lg:items-start lg:text-left'>
