...
function Home(props) {
    ...
    return (
        <>
            <div className='relative w-screen h-screen hidden sm:flex flex-col pt-[70px] sm:pt-0 justify-center items-center bg-borabayLightBrown' id='home' >
                <div className='absolute w-[60px] h-[45px] top-5 left-5 flex justify-center items-center lg:hidden'>
                    <Image className='w-full h-full hidden sm:flex' src={require('../../public/icons/Logo.png')} alt='Logo' />
                </div>
                ...
                <div className='w-[70%] sm:w-[400px] flex flex-col sm:mr-[8%] lg:mr-0 justify-center sm:self-end lg:self-center items-center gap-3'>
                    <span className={`text-white sm:text-borabayDarkBrown font-normal text-lg sm:text-xl text-center font-montserrat`}>Experience Beauty In-Depth  at</span>
                    ...
                    <span className={`text-white sm:text-borabayDarkBrown font-normal text-lg sm:text-xl text-center font-montserrat`}>Where nature and science interact to concept encompassing beauty solutions</span>
            ...
            <div className='relative w-screen h-screen flex flex-col pt-[70px] sm:pt-0 justify-center items-center bg-no-repeat bg-cover bg-img sm:hidden' id='home' >
                <div className='absolute w-[60px] h-[45px] top-5 left-5 flex justify-center items-center lg:hidden'>
                    <Image className='w-full h-full' src={require('../../public/icons/Logo-white.png')} alt='Logo' />
                </div>
                <button className='absolute top-5 right-5 lg:hidden' onClick={() => { setOpenMenu(true) }}>
                    <Image src={require('../../public/icons/ham-menu.png')} height={25} width={40} alt='ham-menu' />
                </button>
