...
function Home(props) {
    return (
        <div className={`relative w-full h-full flex justify-center items-center bg-borabayLightBrown`} id='home' >
            ...
            <div className='pt-[50px] w-[500px] flex flex-col justify-center items-center gap-3'>
                ...
                <span className={`text-borabayBrown font-normal text-8xl`}>Borabay</span>
                <span className={`text-borabayBrown text-2xl tracking-[.60em]`}>THE SALON</span>
